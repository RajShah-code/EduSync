...
router.post('/:id/schedule', protect(['teacher']), scheduleExam);
...
router.patch('/:id/questions/:questionId', protect(['teacher']), updateQuestion);
router.delete('/:id/questions/:questionId', protect(['teacher']), deleteQuestion);
