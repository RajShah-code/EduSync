        ...
        <DialogContent data-role="teacher" className="bg-bg-surface border-border text-text-primary sm:max-w-md">
          ...
          <div className="flex flex-col gap-4 py-2">
            ...
            <div className="relative group">
              ...
              <div style={{ height: '46px', borderRadius: '8px' }} className="border border-solid border-text-secondary focus-within:border-accent-info transition-colors duration-150 flex items-center">
                <input
                  type="text"
            ...
            <div className="relative group">
              ...
              <div style={{ height: '46px', borderRadius: '8px' }} className="relative border border-solid border-text-secondary focus-within:border-accent-info transition-colors duration-150 flex items-center">
                <input
