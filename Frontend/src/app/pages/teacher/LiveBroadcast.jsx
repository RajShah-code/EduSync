        ...
        <DialogContent data-role="teacher" className="bg-bg-surface border-border text-text-primary sm:max-w-md">
          ...
          <div className="flex flex-col gap-4 py-2">
            ...
            <div className="relative">
              ...
              <div style={{ height: '46px', borderRadius: '17px' }} className="border border-solid border-text-secondary flex items-center">
                <input
                  type="text"
            ...
            <div className="relative">
              ...
              <div style={{ height: '46px', borderRadius: '17px' }} className="relative border border-solid border-text-secondary flex items-center">
                <input
