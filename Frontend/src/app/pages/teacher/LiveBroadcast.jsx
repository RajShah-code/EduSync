        ...
        <DialogContent data-role="teacher" className="bg-bg-surface border-border text-text-primary sm:max-w-md">
          ...
          <div className="flex flex-col gap-4 py-2">
            ...
            <div className="relative group">
              ...
              <div style={{ height: '46px', borderRadius: '10px' }} className="border border-solid border-text-secondary focus-within:border-accent-info transition-colors duration-150 flex items-center">
                <input
                  type="text"
            ...
            <div className="relative group">
              ...
              <div style={{ height: '46px', borderRadius: '10px' }} className="relative border border-solid border-text-secondary focus-within:border-accent-info transition-colors duration-150 flex items-center">
                <input
                  ...
                  return (
                    <div key={cls.id} className="relative">
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-[9px] text-xs font-medium border bg-transparent transition-[border-color,color,transform] duration-150 ease-[var(--ease-out-strong)] active:scale-[0.96] flex items-center ${
                          isSelected
