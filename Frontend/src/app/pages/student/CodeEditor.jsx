          ...
          >
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-sm font-semibold text-text-primary flex items-center gap-1.5">
                <HelpCircle className="w-[18px] h-[18px] text-accent-500" />
                Ask a Doubt
              </h2>
              <button
                type="button"
  ...
  return (
    <div className="h-full flex flex-col bg-bg-base overflow-hidden">
      ...
      <div className="h-11 px-2 bg-bg-surface border-b border-border flex items-end gap-1 overflow-x-auto flex-shrink-0" role="tablist" aria-label="Session tasks">
        {tasks.map((t, idx) => {
          ...
          return (
            ...
            >
              {t.locked ? (
                <Lock className="w-3.5 h-3.5 text-accent-500 flex-shrink-0" />
              ) : t.done ? (
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        >
          {sidebarCollapsed && <ChevronRight className="w-3.5 h-3.5 text-text-muted" />}
        </div>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="h-12 px-3 border-b border-border bg-bg-surface flex items-center justify-between gap-3 flex-shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <HelpCircle className="w-[18px] h-[18px] mr-1.5" />
              ...
              >
                {pyodideLoading ? (
                  ...
                  <>
                    <Play className="w-[18px] h-[18px] mr-1.5" />
        ...
        >
          {outputCollapsed && <ChevronLeft className="w-3.5 h-3.5 text-text-muted" />}
        </div>
